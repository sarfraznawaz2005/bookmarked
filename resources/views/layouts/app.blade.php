        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"><a class="btn btn-light" href="/">Dashboard</a></li>
                    <li class="nav-item"><a class="btn btn-light" href="/">Add New</a></li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="btn btn-light dropdown-toggle" href="#" role="button"
